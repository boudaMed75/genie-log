...
<div id="acceil" class="scroll-value page1">
        <div class="header" id="header">
            <div class="container">
                ...
                <ul id="nav-scren-large" class="main-nav">
                    <li><a class="active" data-section="acceil" href="index.php">Accueil</a></li>
                    <li><a ata-section="ajouter_clien" href="ajouter-client.php">ajouter un Client</a></li>
        ...
        <div class="landing-admin-index">
            <h3 class="service-titre">Bonjour Dans l'administration Genie Log</h3>
            <img src="../img/fina.png" alt="">
        </div>
    </div>
